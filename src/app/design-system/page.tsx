...
const swatches = [
  ...
  },
  {
    name: 'Card',
    token: 'bg-card',
    text: 'text-card-foreground border border-border',
  },
  { name: 'Muted', token: 'bg-muted', text: 'text-muted-foreground' },
  {
    name: 'Destructive',
    token: 'bg-destructive/20',
    text: 'text-destructive border border-destructive/30',
  },
];
  ...
  return (
    <div className="mx-auto max-w-4xl px-4 py-12">
      ...
      <p className="mt-2 max-w-2xl text-muted-foreground">
        Built on shadcn/ui (base-nova). Dark-first, amber accent, workout-native
        landing motifs. Review live flows at{' '}
        <code className="text-primary">/</code>,{' '}
        <code className="text-primary">/intake</code>,{' '}
        <code className="text-primary">/waitlist</code>,{' '}
        <code className="text-primary">/admin</code>,{' '}
        <code className="text-primary">/legal/refund</code>. Full checklist:{' '}
        <code className="text-primary">
          docs/product/designer-review-checklist.md
        </code>
      </p>
      ...
      <section className="mt-12">
        ...
        <p className="mt-2 text-sm text-muted-foreground">
          Brand asset:{' '}
          <code className="text-primary">public/brand/sthir-logo.png</code> —
          used in header, footer, favicon, and OG image.
        </p>
        ...
        <p className="mt-3 text-xs text-muted-foreground">
          Header uses{' '}
          <code className="text-primary">sthir-logo-compact.png</code>{' '}
          (transparent). Favicon uses{' '}
          <code className="text-primary">sthir-logo-mark.png</code>.
        </p>
      </section>
      ...
      <section className="mt-12">
        ...
        <div className="mt-4 grid gap-3 sm:grid-cols-2">
          {swatches.map((s) => (
            <div
              key={s.name}
              className={`rounded-lg px-4 py-6 ${s.token} ${s.text}`}
            >
              {s.name}
            </div>
          ))}
      ...
      <section>
        ...
        <div className="mt-4 space-y-2">
          ...
          <p className="text-muted-foreground">
            Body — muted foreground for secondary copy
          </p>
          <p className="font-mono text-sm text-primary">
            STHIR-DEL-01 — mono for codes
          </p>
        </div>
      </section>
      ...
      <section>
        ...
        <Card className="mt-4">
          <CardHeader>
            ...
            <CardDescription>
              Intake & waitlist use these patterns
            </CardDescription>
          </CardHeader>
      ...
      <section>
        ...
        <Alert className="mt-4">
          ...
          <AlertDescription>
            Program delivered within 12 hours SLA.
          </AlertDescription>
        </Alert>
      ...
      <section>
        ...
        <ul className="mt-4 list-inside list-disc space-y-2 text-sm text-muted-foreground">
          <li>
            Brand feels serious PL / warehouse gym — not generic fitness app?
          </li>
          ...
          <li>
            Any copy/layout changes → attach PNG + page URL in GitLab issue
          </li>
        </ul>
      </section>
    </div>
